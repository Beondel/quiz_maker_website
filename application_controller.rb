...
class MyApp < Sinatra::Base
  ...
  quiz8 = Quiz.new("Christopher Nolan", "Name all of the movies Nolan has directed", "interstellar, inception, memento, insomnia, dark knight rises, dark knight, batman begins, the prestige, following, doodlebug")
